...
export const ICONS = {
  ...
  portal: '<svg class="icon icon-lg" viewBox="0 0 24 24"><path d="M6 21v-9a6 6 0 0 1 12 0v9"/><path d="M9 21v-7a3 3 0 0 1 6 0v7"/></svg>',
  ...
  vehicle: '<svg class="icon icon-lg" viewBox="0 0 24 24"><path d="M5 17H3a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h13l3 4H3"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>',
  layers: '<svg class="icon icon-lg" viewBox="0 0 24 24"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>',
